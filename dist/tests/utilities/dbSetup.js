...
class DbSetup {
    constructor() {
        ...
        /*
          ...
          */
        // administrator
        this.admin = this.users.filter(function (user) {
        ...
        this.userWithActiveOrder = this.users.filter((user) => user.username === 'userWithActiveOrder' && user.user_type === 'regular')[0];
        this.categories = [
            { id: 1, name: 'Books' },
        ...
        this.activeOrder = this.orders.filter((order) => order.order_status == 'active')[0];
        ...
        this.numberOfItemsInActiveOrder = this.orderItems.reduce((total, currentItem) => currentItem.order_id == this.activeOrder.id ? total + 1 : total, 0);
        ...
        this.completedOrders = new Set(this.orders.map((order) => {
        ...
        this.numberOfItemsInCompletedOrders = this.orderItems.reduce((total, currentItem) => this.completedOrders.has(currentItem.order_id) ? total + 1 : total, 0);
